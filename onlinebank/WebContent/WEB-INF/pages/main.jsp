...
<!--       <param name="movie" value="resources/images/banks.swf" /> -->
<!--       <param name="quality" value="high" /> -->
<!--       <embed src="resources/images/banks.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="900" height="90"></embed> -->
<!--     </object></th> -->
<!--   </tr> -->
<!--   <tr> -->
<!--     <td colspan="3">&nbsp;</td> -->
...
<!--   <ul> -->
<%--     <li><a href="main">Welcome,&nbsp;<%=(String)session.getAttribute("cust_name")%></a></li> --%>
<!--     <li><a href="createAccount">Create Account</a></li> -->
<!-- 	<li><a href="depositAccount">Deposite</a></li> -->
<!--     <li><a href="withdrawMoney">Do Withdraw</a></li> -->
